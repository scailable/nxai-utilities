...
EXPORT_MACRO void nxai_thread_join(nxai_thread_t thread);
...
EXPORT_MACRO bool nxai_thread_create(nxai_thread_t* thread, function_ptr function, void* input_arguments);

EXPORT_MACRO void nxai_lock_mutex(nxai_mutex_t* mutex);

EXPORT_MACRO void nxai_unlock_mutex(nxai_mutex_t* mutex);

EXPORT_MACRO nxai_mutex_t nxai_initialize_mutex();

EXPORT_MACRO void nxai_atomic_increment(volatile unsigned int* number);

EXPORT_MACRO void nxai_atomic_decrement(volatile unsigned int* number);
